About naif_eop_high_prec-feedstock
==================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/naif_eop_high_prec-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/naif_eop_high_prec-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add naif_eop_high_prec
# for installing globally
pixi global install naif_eop_high_prec
```
...
It is possible to list all of the versions of `naif_eop_high_prec` available on your platform:
...
```
pixi search naif_eop_high_prec --channel conda-forge
```
